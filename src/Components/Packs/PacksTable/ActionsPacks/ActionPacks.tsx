    ...
    <div>
      ...
      {props.userId == props.creatorUserId && (
          <Tooltip title="edit">
              ...
              />
              <Modal title="Edit pack" visible={isEditModalVisible} onOk={handleEditOk} onCancel={handleCancel}>
      ...
      {props.userId == props.creatorUserId && (
          <Tooltip title="delete">
              ...
              />
              <Modal title="Delete pack" visible={isDeleteModalVisible} onOk={handleDeleteOk} onCancel={handleCancel}>
                  <span>
